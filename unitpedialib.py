...
class InformationArticles:
    ...
    #kilogram
    articles.append(InformationArticle( "kilogra(m|mm)(e| )", "Kilogramme or Kilogram", "kg", "Mass", "France, 1799", "The kilogram was originally defined in 1795 as the mass of a litre of water. This was a convenient definition, but hard to replicate precisely. In 1799, the Kilogramme des Archives, a platinum artefact, replaced it as a standard mass sample. Later, the International Prototype of the Kilogram (IPK) became the standard of the unit of mass for the metric system, and remained so until May 20, 2019. In spite of best efforts to maintain it, the IPK diverged from its replicas by approximately 50 micrograms since their manufacture late in the 19th century. This led to efforts to develop measurement technology precise enough to allow replacing the kilogram artefact with a definition based directly on physical fundamental constants. This was achieved in 2018, with a definition in terms of the Planck constant. Thus, the kilogram is now defined in terms of the second and the metre, eliminating the need for the IPK. The new definition was approved by the General Conference on Weights and Measures (CGPM) on November 16, 2018.", "Yes", "https://en.wikipedia.org/wiki/Kilogram"))
